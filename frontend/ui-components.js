...
export function TodoList({ todoList }) {
  ...
  function checkCompleteTodo(index) {
  ...
  return (
    <main>
      <div>
        ...
        {todoList?.in_progress.length > 0 ? (
          <ul>
            {todoList?.in_progress.map((task, index) => (
              <li className="flex space-between" key={index}>
                ...
                <div>
                  <button
                    onClick={() => {
                      const content = prompt("Update to do", task);
                  ...
                  <button
                    onClick={() => {
                      checkCompleteTodo(index);
                    }}
                    className="margin-left success"
                  >
                    Complete
                  </button>
                </div>
      ...
      {todoList?.completed.length > 0 && (
        <div>
          <div className="flex space-between">
            ...
            <button className="danger" onClick={clearCompleteTasks}>
              Clear
            </button>
          </div>
          <ul>
